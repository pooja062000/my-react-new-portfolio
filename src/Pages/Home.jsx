...
function Home(){
    ...
    <div class='servies-cont'>
                   ...
                   <div className='services-border-main'>
                    ...
                    <div className='services-border1'></div>
                    <div className='services-border1'></div>
                    <div className='services-border2'></div>
                    </div>
    ...
    <div className="services-box1">
        ...
        <h6 className="favicon-icon">Ui Development</h6>
        </div>
    ...
    <i class="fa fa-line-chart"></i>
            ...
            <h6 className="favicon-icon">Web designing</h6>
        </div>
        ...
        <i class="fa fa-search"></i>
            <h6 className="favicon-icon">Ui Research</h6>
            </div>
        </div>
        </div>
